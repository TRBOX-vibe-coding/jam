...
const badgeStyles: Record<string, string> = {
  ...
  '진행 중': 'bg-ok-soft text-ok',
  '오픈 예정': 'bg-brand-soft text-brand',
  '승인 대기': 'bg-warn-soft text-warn',
  '품절': 'bg-line text-ink-3',
  '마감': 'bg-line text-ink-3',
  '작성 중': 'bg-line text-ink-3',
  '반려됨': 'bg-bad-soft text-bad',
  '취소됨': 'bg-bad-soft text-bad',
