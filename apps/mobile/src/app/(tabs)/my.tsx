...
const st = StyleSheet.create({
  ...
  hero: { fontSize: 19, fontWeight: '900', color: C.ink, textAlign: 'center' },
  ...
  section: { fontSize: 13, fontWeight: '800', color: C.ink3, marginTop: 16, marginBottom: 8 },
  planName: { fontSize: 16, fontWeight: '800', color: C.ink },
  planDesc: { fontSize: 12, color: C.ink3, marginTop: 2 },
  planPrice: { fontSize: 16, fontWeight: '900', color: C.brand },
